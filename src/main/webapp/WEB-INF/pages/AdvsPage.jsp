...
<t:indexpage>
	...
	<c:forEach items="${advsList}" var="adv">
				<article>
						<div class="post-image">
							<div class="post-heading">
								<h3><a href="${Constants.URL}article/full/${adv.id}">${adv.title}</a></h3>
							</div>
						</div>
						<p>
						${adv.textEN}
						...
						<div class="bottom-article">
							<ul class="meta-post">
								<li><i class="icon-calendar"></i><a href="#">${adv.date}</a></li>
							</ul>
							<a href="${Constants.URL}article/full/${adv.id}" class="pull-right">Continue reading <i class="icon-angle-right"></i></a>
						</div>
				</article>
