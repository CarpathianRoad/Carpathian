...
<t:adminpage>
    ...
    <div class="margintop20">
        ...
        <ol class="breadcrumb">
            <li class="active">
                <a href="${Constants.URL}system/users"> <i class="fa fa-fw fa-list-alt"></i> Back to filters</a>
            </li>
        </ol>
	<div class="row add-row">
                <div class="col-lg-12 margintop30">
                    ...
                    <form action="${Constants.URL}system/filters/do/deletedata.do" name="addArticleForm" id="addForm" method="POST" type="multipart/form-data">
